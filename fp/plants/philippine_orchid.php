...
<div class="section group page-ID-container">
  <p class="col span_6_of_6 page-ID">Home > Plants > Philippine Orchid</p>
</div>
<div class="section group main-aside-plants">
  <!-- START LEFT COL -->
  <main class="col span_3_of_6 main-plant-col">
    <p>
      <img src="../images/stock/medinillaFree.jpg" alt = "Philippine Orchid" title="Philippine Orchid">
    </p>
  </main>
  <!-- END LEFT COL -->
  <!-- START RIGHT COL -->
  <aside class="col span_3_of_6">
    <h3 class="cname">Philippine Orchid</h3>
    <h4 class="sname"><em>(Mednilla magnifica)</em></h4>
    <p>Categories:</p>
    <ul class="ctg-list">
      <li><p>Maturity Size: Medium</p></li>
      <li><p>Light: Indirect sun</p></li>
      <li><p>Humidity: High</p></li>
      <li><p>Pet Friendly: Yes</p></li>
    </ul>
    <p>Origin: The Philippines</p>
    <p>
    ...
    <div id='product-component-062eaf86412' class="buy-button"></div>
            ...
            function ShopifyBuyInit() {
                ...
                ShopifyBuy.UI.onReady(client).then(function (ui) {
                    ui.createComponent('product', {
                        id: [1777728651315],
                        node: document.getElementById('product-component-062eaf86412'),
