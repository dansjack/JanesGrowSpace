...
<div class="section group page-ID-container">
  <p class="col span_6_of_6 page-ID">Home > Plants > Variegated Split Leaf Philodendron</p>
</div>
<div class="section group main-aside-plants">
  <!-- START LEFT COL -->
  <main class="col span_3_of_6 main-plant-col">
    <p>
      <img src="../images/stock/variegatedFree.jpg" alt = "Variegated Split Leaf Philodendron" title="Variegated Split Leaf Philodendron">
    </p>
  </main>
  <!-- END LEFT COL -->
  <!-- START RIGHT COL -->
  <aside class="col span_3_of_6">
    <h3 class="cname">Variegated Split Leaf Philodendron</h3>
    <h4 class="sname"><em>(Monstera Deliciosa)</em></h4>
    <p>Categories: (FILL)</p>
    <p>Origin: Tropical Mexico and Central America</p>
    <p>
    ...
    <div id='product-component-c9fe7e876f6' class="buy-button"></div>
            ...
            function ShopifyBuyInit() {
                ...
                ShopifyBuy.UI.onReady(client).then(function (ui) {
                    ui.createComponent('product', {
                        id: [1777723768883],
                        node: document.getElementById('product-component-c9fe7e876f6'),
