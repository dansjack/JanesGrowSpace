...
<div class="section group page-ID-container">
  <p class="col span_6_of_6 page-ID">Home > Plants > Dwarf Pineapple</p>
</div>
<div class="section group main-aside-plants">
  <!-- START LEFT COL -->
  <main class="col span_3_of_6 main-plant-col">
    <p>
      <img src="../images/stock/pineappleFree.jpg" alt = "Dwarf Pineapple" title="Dwarf Pineapple">
    </p>
  </main>
  <!-- END LEFT COL -->
  <!-- START RIGHT COL -->
  <aside class="col span_3_of_6">
    <h3 class="cname">Dwarf Pineapple</h3>
    ...
    <div id='product-component-8742126b8b6' class="buy-button"></div>
            ...
            function ShopifyBuyInit() {
                ...
                ShopifyBuy.UI.onReady(client).then(function (ui) {
                    ui.createComponent('product', {
                        id: [1777727209523],
                        node: document.getElementById('product-component-8742126b8b6'),
