...
<?PHP include '../includes/header.php';?>
    ...
    <div class="section group page-ID-container">
        <p class="col span_6_of_6 page-ID">Home > Plants > Ficus Audrey</p>
    </div>
    <div class="section group main-aside-plants">
        <!-- START LEFT COL -->
        <main class="col span_3_of_6 main-plant-col">
            <p>
                <img src="../images/stock/ficusFree.jpg" alt = "Ficus Audrey" title="Ficus Audrey">
            </p>
        </main>
        <!-- END LEFT COL -->
        <!-- START RIGHT COL -->
        <aside class="col span_3_of_6">
            <h3 class="cname">Ficus Audrey</h3>
            <h4 class="sname"><em>(Ficus benghalensis)</em></h4>
            <p>Categories:</p>
            <ul class="ctg-list">
          ...
          <div id='product-component-da56c06c829' class="buy-button"></div>
                  ...
                  function ShopifyBuyInit() {
                      ...
                      ShopifyBuy.UI.onReady(client).then(function (ui) {
                          ui.createComponent('product', {
                              id: [1777714495539],
                              node: document.getElementById('product-component-da56c06c829'),
