...
<div class="section group page-ID-container">
  <p class="col span_6_of_6 page-ID">Home > Plants > Triostar</p>
</div>
<div class="section group main-aside-plants">
  <!-- START LEFT COL -->
  <main class="col span_3_of_6 main-plant-col">
    <p>
      <img src="../images/stock/stromantheFree.JPG" alt = "Triostar" title="Triostar">
    </p>
  </main>
  <!-- END LEFT COL -->
  <!-- START RIGHT COL -->
  <aside class="col span_3_of_6">
    <h3 class="cname">Triostar</h3>
    <h4 class="sname"><em>(Stromanthe sanguinea)</em></h4>
    <p>Categories:</p>
    <ul class="ctg-list">
    ...
    <p>Origin: Brazilian rain forests</p>
    <p>
    ...
    <div id='product-component-874e0519bb5' class="buy-button"></div>
            ...
            function ShopifyBuyInit() {
                ...
                ShopifyBuy.UI.onReady(client).then(function (ui) {
                    ui.createComponent('product', {
                        id: [1777724817459],
                        node: document.getElementById('product-component-874e0519bb5'),
