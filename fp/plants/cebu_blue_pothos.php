...
<div class="section group page-ID-container">
  <p class="col span_6_of_6 page-ID">Home > Plants > Cebu Blue Pothos</p>
</div>
<div class="section group main-aside-plants">
  <!-- START LEFT COL -->
  <main class="col span_3_of_6 main-plant-col">
    <p>
      <img src="../images/stock/epipremnumFree.jpg" alt = "Cebu Blue Pothos" title="Cebu Blue Pothos">
    </p>
  </main>
  <!-- END LEFT COL -->
  <!-- START RIGHT COL -->
  <aside class="col span_3_of_6">
    <h3 class="cname">Cebu Blue Pothos</h3>
    ...
    <div id='product-component-904c8064b84' class="buy-button"></div>
            ...
            function ShopifyBuyInit() {
                ...
                ShopifyBuy.UI.onReady(client).then(function (ui) {
                    ui.createComponent('product', {
                        id: [1777725702195],
                        node: document.getElementById('product-component-904c8064b84'),
