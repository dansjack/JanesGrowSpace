...
<?PHP include '../includes/header.php';?>
    ...
    <div class="section group page-ID-container">
        <p class="col span_6_of_6 page-ID">Home > Plants > (COMMON NAME)</p>
    </div>
    <div class="section group main-aside-plants">
        <!-- START LEFT COL -->
        <main class="col span_3_of_6 main-plant-col">
            <p>
                <img src="FILL" alt = "FILL" title="FILL">
            </p>
        </main>
        <!-- END LEFT COL -->
        <!-- START RIGHT COL -->
        <aside class="col span_3_of_6">
            <h3 class="cname">(COMMON NAME)</h3>
            <h4 class="sname"><em>(SCIENTIFIC NAME)</em></h4>
            <p>Categories: (FILL)</p>
            <p>Origin: (FILL)</p>
            <p>
            ...
            <!-- Shopify div goes here -->
            <!-- Shopify script goes here -->
        </aside>
    </div>
    <!-- END RIGHT COL -->
    <!--START FOOTER HERE-->
