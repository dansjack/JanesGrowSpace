...
<div class="section group page-ID-container">
    <p class="col span_6_of_6 page-ID">Home > Plants > Chinese Evergreen</p>
</div>
<div class="section group main-aside-plants">
    <!-- START LEFT COL -->
    <main class="col span_3_of_6 main-plant-col">
        <p>
            <img src="../images/stock/aglaonemaFree.jpg" alt = "Chinese Evergreen" title="Chinese Evergreen">
        </p>
    </main>
    <!-- END LEFT COL -->
    <!-- START RIGHT COL -->
    <aside class="col span_3_of_6">
        <h3 class="cname">Chinese Evergreen</h3>
        ...
        <div id='product-component-08d089c6a7c' class="buy-button"></div>
                ...
                function ShopifyBuyInit() {
                    ...
                    ShopifyBuy.UI.onReady(client).then(function (ui) {
                        ui.createComponent('product', {
                            id: [1777711022131],
                            node: document.getElementById('product-component-08d089c6a7c'),
