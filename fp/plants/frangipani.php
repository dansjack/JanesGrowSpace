...
<?PHP include '../includes/header.php';?>
    ...
    <div class="section group page-ID-container">
        <p class="col span_6_of_6 page-ID">Home > Plants > Frangipani</p>
    </div>
    <div class="section group main-aside-plants">
        <!-- START LEFT COL -->
        <main class="col span_3_of_6 main-plant-col">
            <p>
                <img src="../images/stock/plumeriaFree.jpg" alt = "Frangipani" title="Frangipani">
            </p>
        </main>
        <!-- END LEFT COL -->
        <!-- START RIGHT COL -->
        <aside class="col span_3_of_6">
          ...
          <div id='product-component-7a4f10d21ac' class="buy-button"></div>
                  ...
                  function ShopifyBuyInit() {
                      ...
                      ShopifyBuy.UI.onReady(client).then(function (ui) {
                          ui.createComponent('product', {
                              id: [1777705418803],
                              node: document.getElementById('product-component-7a4f10d21ac'),
