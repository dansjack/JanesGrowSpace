...
<?PHP include '../includes/header.php';?>
    ...
    <div class="section group page-ID-container">
        <p class="col span_6_of_6 page-ID">Home > Plants > Button Fern</p>
    </div>
    <div class="section group main-aside-plants">
        <!-- START LEFT COL -->
        <main class="col span_3_of_6 main-plant-col">
            <p>
                <img src="../images/stock/rotundifoliaFree.jpg" alt = "Button Fern" title="Button Fern">
            </p>
        </main>
        <!-- END LEFT COL -->
        <!-- START RIGHT COL -->
        <aside class="col span_3_of_6">
          ...
          <div id='product-component-c3011a9ec2d' class="buy-button"></div>
                  ...
                  function ShopifyBuyInit() {
                      ...
                      ShopifyBuy.UI.onReady(client).then(function (ui) {
                          ui.createComponent('product', {
                              id: [1777716101171],
                              node: document.getElementById('product-component-c3011a9ec2d'),
