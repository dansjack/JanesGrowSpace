...
<div class="section group page-ID-container">
    <p class="col span_6_of_6 page-ID">Home > Plants > Oak Leaf Philodendron</p>
</div>
<div class="section group main-aside-plants">
    <!-- START LEFT COL -->
    <main class="col span_3_of_6 main-plant-col">
        <p>
            <img src="../images/stock/pedatumFree.jpg" alt = "Oak Leaf Philodendron" title="Oak Leaf Philodendron">
        </p>
    </main>
    <!-- END LEFT COL -->
    <!-- START RIGHT COL -->
    <aside class="col span_3_of_6">
        <h3 class="cname">Oak Leaf Philodendron</h3>
        <h4 class="sname"><em>(Pedatum philodendron)</em></h4>
        <p>Categories:</p>
        <ul class="ctg-list">
      ...
      <div id='product-component-8b903b99d34' class="buy-button"></div>
              ...
              function ShopifyBuyInit() {
                  ...
                  ShopifyBuy.UI.onReady(client).then(function (ui) {
                      ui.createComponent('product', {
                          id: [1777700864051],
                          node: document.getElementById('product-component-8b903b99d34'),
